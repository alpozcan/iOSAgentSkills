...
- **Stub override pattern** (`Catalog.main.register` in test setup) enables full integration testing without external services — see [[09-debug-modes-and-mock-service-strategy]] for the three-tier mock system
